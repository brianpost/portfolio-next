...
const Home: NextPage = () => {
    ...
    const ProjectCard = ({title, imageName, children}: {title: string, imageName: string, children: React.ReactNode}) => {
    ...
    return (
        <React.Fragment>
            <Head>
                ...
                <link
                    href="https://fonts.googleapis.com/css2?family=Lora:ital,wght@0,400;0,600;0,700;1,400;1,500;1,600;1,700&display=swap"
                    rel="stylesheet"
                />
            </Head>
                ...
                <div className="container">
                    ...
                    <section>
                        ...
                        <div className="row justify-content-center mb-5">
                            <PageColumn>
                                <ProjectCard title="Northwestern University Law Review" imageName="nulr.png">
                    ...
                    <div className="row justify-content-center p-1">
                        <PageColumn>
                            <div className="text-center">
                                Built with <FooterTechLink href="https://nextjs.org/">Next.js</FooterTechLink>
